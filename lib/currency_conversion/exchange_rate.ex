defmodule CurrencyConversion.ExchangeRate do
  ...
  @type user_params :: %{base_currency: String.t(), target_currency: String.t(), amount: String.t()}
  @type application_response :: %{base_currency: String.t(), target_currency: String.t(), amount: String.t(), message: String.t()}
  ...
  defp endpoint() do
    Application.get_env(:currency_conversion, ExchangeRate)
